...
<title>eShop</title>
    ...
    <script type="text/javascript" src="mdboostrap/js/popper.min.js"></script>
    <script src="filterbyname.js"></script>
...
<header>
        ...
        <main>
            ...
            <div class="container" style="width:100%; margin-top: 80px" class="col 12">
            <div class="row">
            <button id="procesory" class="col btn-default btn-sm filter-button" data-filter="all">Procesory</button>
            ...
            <button id="zasilacze" class="col btn-default btn-sm filter-button" data-filter="zasilacze">Zasilacze</button>
            <button id="dyski" class="col  btn-default btn-sm filter-button" data-filter="inne">Dyski</button>
            <button id="obudowy" class="col btn-default btn-sm filter-button" data-filter="obudowy">Obudowy</button>
            </div>
            <div class="row">
            
            <!-- <input type="search" class="form-control" id="searchproducts" aria-describedby="productHelp" placeholder="Wpisz produkt"> -->
            </div>
             </div> 
            ...
            <div class="row" id="myrow">
                <?php
                    ...
                    <div class="card col-lg-4 row-md-4 row-sm-2 col-xs-1 pro filter <?php echo $produkt['filter']?>">
                        <form method="post" action="zestaw.php?action=add&id=<?php echo $produkt['id_produktu'];?>">

                            <div class="products">
                                <input type="image" style="card-img-top mh200-text" class="img-responsive" src="discount/<?php echo $produkt['zdjecie'];?>"/>
                                <h4 class="card-title mw30-text produkti"><?php echo $produkt['nazwa_produktu'];?></h4>
                                <!-- promo <h6><s><?php echo ($produkt['cena']*1.15)?></s></h6> -->
                                ...
                                <input type="submit" name="koszyk" class="btn btn-success"
        ...
        ?>
                    <tr>
                        ...
                        <th><input style="margin-right:auto; width:80px;" type="number" name="quantity"
                                    class="form-control" min="1" value="<?php echo $produkt['quantity']?>" /></th>
                        ...
                        <th>
                            <a href="zestaw.php?action=delete&id=<?php echo $produkt['id'];?>">
        ...
        ?>
                ...
                ?>
                            <a href="validator.php?platnosc" class="order btn btn-danger">Przejdź do Zamówienia</a>
