...
<header>
        ...
        <main>
            ...
            <div class="container memu--list row-md-4 row-sm-3 row-xs-2" style="width:100%; margin-top: 80px">
            <div class="row">
            ...
            <button id="smartphone" class="col btn-default btn-sm filter-button" data-filter="laptopy">SmartPhony</button>
            </div>
            ...
            <div class="row" id="myrow">
                <?php
                    ...
                    <div class="card col-lg-4 row-md-4 row-sm-2 col-xs-1 pro filter <?php echo $produkt['filter']?>">
                        <form method="post" action="asortyment.php?action=add&id=<?php echo $produkt['id_produktu'];?>">
        ...
        ?>
                    <tr>
                        ...
                        <th>
                            <a href="asortyment.php?action=delete&id=<?php echo $produkt['id'];?>">
